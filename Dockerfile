...
RUN cp /opt/soft/php-7.2.0/sapi/fpm/init.d.php-fpm /etc/init.d/php-fpm && chmod +x /etc/init.d/php-fpm &&   apt-get clean && rm -rf /opt/soft  && ln -s /usr/local/php/bin/* /usr/local/bin/
