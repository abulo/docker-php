...
RUN mkdir -pv /opt/soft ;\
	...
	cd /opt/soft;\
	echo "安装libsodium" ;\
	wget https://github.com/jedisct1/libsodium/archive/1.0.16.tar.gz ;\
	...
	python -mpip install -U matplotlib --ignore-installed six ;\
	echo "安装 opencv";\
	...
	rm 3.4.1.tar.gz ;\
	mkdir -pv /opt/soft/opencv/build ;\
...
RUN mkdir -pv /opt/soft ;\
	...
	cd /opt/soft;\
	echo "编译 php-ds" ;\
	git clone https://github.com/php-ds/extension.git   ;\
	cd extension ;\
	/usr/local/php/bin/phpize ;\
	./configure --with-php-config=/usr/local/php/bin/php-config ;\
	make ;\
	...
	cd inotify-2.0.0 ;\ /usr/local/php/bin/phpize ;\
	./configure  --with-php-config=/usr/local/php/bin/php-config  ;\
	make ;\
	make install ;\
	cd /opt/soft;\
	echo "编译mongodb" ;\
	wget -c http://pecl.php.net/get/mongodb-1.4.2.tgz ;\
	...
	tar -zxf libdatrie-0.2.5.tar.gz ;\
	cd  libdatrie-0.2.5 ;\
	...
	cd /opt/soft;\
	echo "敏感词过滤PHP 扩展" ;\
	wget https://github.com/abulo/php-ext-trie-filter/archive/v1.0.tar.gz ;\
	tar zxvf v1.0.tar.gz  ;\
	cd php-ext-trie-filter-1.0  ;\
	/usr/local/php/bin/phpize ;\
