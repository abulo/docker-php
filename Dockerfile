...
#安装libsodium
RUN mkdir -pv /opt/soft && cd /opt/soft && wget https://github.com/jedisct1/libsodium/archive/1.0.16.tar.gz && tar -zxf 1.0.16.tar.gz && cd libsodium-1.0.16 && ./configure && make && make check && make install  && rm -rf /opt/soft
...
#编译 libsodium-php
RUN mkdir -pv /opt/soft && cd /opt/soft && wget https://github.com/jedisct1/libsodium-php/archive/2.0.10.tar.gz && tar -zxf 2.0.10.tar.gz  && cd libsodium-php-2.0.10 && ./configure --with-php-config=/usr/local/php/bin/php-config && make && make install && rm -rf /opt/soft

#编译 php-ds
RUN mkdir -pv /opt/soft && cd /opt/soft && wget https://github.com/php-ds/extension/archive/v1.2.4.tar.gz && tar -zxf v1.2.4.tar.gz   && cd extension-1.2.4 && ./configure --with-php-config=/usr/local/php/bin/php-config && make && make install && rm -rf /opt/soft
