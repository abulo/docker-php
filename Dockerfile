...
#编译nghttp2
#RUN mkdir -pv /opt/soft && cd /opt/soft && git clone https://github.com/nghttp2/nghttp2.git --depth=1 && cd nghttp2 && git submodule update --init && autoreconf -i && automake && autoconf && ./configure && make && make install && rm -rf /opt/soft
